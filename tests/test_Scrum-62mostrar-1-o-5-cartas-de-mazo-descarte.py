...
def client_fixture(session):
    """Crea el cliente de FastAPI y aplica override de DB."""
    def get_db_override():
        yield session
...
@patch("game.partidas.utils.PartidaService")
@patch("game.partidas.utils.CartaService")
def test_obtener_cartas_descarte_cantidad_invalida(mock_CartaService, mock_PartidaService, client):
...
@patch("game.partidas.utils.PartidaService")
@patch("game.partidas.utils.CartaService")
def test_obtener_cartas_descarte_partida_no_encontrada(mock_CartaService, mock_PartidaService, client):
